...
exports.deleteTag = exports.updateTag = exports.createTags = exports.getAllTagLabels = exports.getTags = void 0;
...
function getTags(_, args, { identity }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const thing = yield tagDAO_1.default.findTags(query);
        console.log(thing);
        return thing;
    });
}
exports.getTags = getTags;
function getAllTagLabels(_, __, { identity }) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, routeUtils_1.requireRole)(identity, types_1.Role.ReadOnly);
        return yield tagDAO_1.default.getAllTagLabels();
    });
}
exports.getAllTagLabels = getAllTagLabels;
